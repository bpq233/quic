#define NGX_CONFIGURE " --prefix=/home/bpq/quic/nginx --with-debug --with-http_v3_module --with-cc-opt=-I../boringssl/include --with-ld-opt='-L../boringssl/build/ssl -L../boringssl/build/crypto'"
...
#ifndef NGX_COMPILER
#define NGX_COMPILER  "gcc 9.4.0 (Ubuntu 9.4.0-5ubuntu1) "
#endif
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/home/bpq/quic/nginx/"
#endif
