#define NGX_CONFIGURE " --prefix=/home/bpq/NginxWithQuic/nginx --with-debug --with-http_v3_module --with-cc-opt=-I../boringssl/include --with-ld-opt='-L../boringssl/build/ssl -L../boringssl/build/crypto'"
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/home/bpq/NginxWithQuic/nginx/"
#endif
