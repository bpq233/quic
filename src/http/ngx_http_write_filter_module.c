...
ngx_http_write_filter(ngx_http_request_t *r, ngx_chain_t *in)
{
    ...
    *ll = NULL;
    ...
    //r->limit_rate = _rate;
    // if (r->limit_rate == 0) 
    //     r->limit_rate = 10000000;
    // if (r->limit_rate < 500000) {
    //     printf("%ld\n", r->limit_rate);
    // }
    //printf("------%d %d %.3f %d %d %ld\n", f_size, buffer, loss_rtt * 100, rate, rank, r->limit_rate);
